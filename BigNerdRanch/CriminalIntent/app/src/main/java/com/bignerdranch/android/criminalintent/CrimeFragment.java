...
public class CrimeFragment extends Fragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //UUID crimeId = (UUID) getActivity().getIntent().getSerializableExtra(CrimeActivity.EXTRA_CRIME_ID); shortcut code
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        //pickContact.addCategory(Intent.CATEGORY_HOME); dummy code to disable button
    ...
    private void updateDate() {
        mDateButton.setText(Crime.getFormatedDate(mCrime.getDate()));
    }
